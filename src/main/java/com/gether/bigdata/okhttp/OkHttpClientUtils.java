...
public class OkHttpClientUtils {
  ...
  public static String postWithBody(String url, String json, long timeout, TimeUnit timeUnit)
      throws HttpRequestException {
    Request request = createPostBody(url, json);
    OkHttpClient okHttpClient = client.newBuilder().readTimeout(timeout, timeUnit)
        .connectTimeout(timeout, timeUnit).writeTimeout(timeout, timeUnit).build();
  ...
  public static String post(String url, Map<String, String> params, long timeout, TimeUnit timeUnit)
      throws HttpRequestException {
    FormBody.Builder builder = new FormBody.Builder();
    for (String key : params.keySet()) {
      builder.add(key, params.get(key));
  ...
  private static Response execute(OkHttpClient okHttpClient, Request request)
      throws HttpRequestException {
    try {
