...
import com.gether.bigdata.util.GenericsUtils;
...
public class LockAspect {
  ...
  @Around("within(com.gether.bigdata.*) && @annotation(myLock)")
  public Object addLock(ProceedingJoinPoint point, DistributedLockAnnotation myLock)
      throws Throwable {
    Object object = null;
    try {
